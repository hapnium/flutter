...
class PinItemConfig {
  ...
  /// Merge two [PinItemConfig] into one
  PinItemConfig apply({required PinItemConfig theme}) {
    return PinItemConfig(
  ...
  /// Create a new [PinItemConfig] from the current instance
  PinItemConfig copyWith({
    double? width,
    double? height,
    TextStyle? textStyle,
  ...
  /// Create a new [PinItemConfig] from the current instance with new decoration
  PinItemConfig copyDecorationWith({
    Color? color,
  ...
  /// Create a new [PinItemConfig] from the current instance with new border
  PinItemConfig copyBorderWith({required Border border}) {
    assert(decoration != null);
    return copyWith(
