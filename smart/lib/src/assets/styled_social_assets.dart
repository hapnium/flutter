...
class SmartStyledSocialAssets {
  /// Returns the base path for assets within the 'assets/app' directory.
  static String _base(String name) => "packages/smart/assets/social_styled/$name.png";
  ...
  /// The path to the "facebook" asset.
  static String facebook = _base("facebook");

  /// The path to the "twitter" asset.
  static String twitter = _base("twitter");

  /// The path to the "snapchat" asset.
  static String snapchat = _base("snapchat");
}